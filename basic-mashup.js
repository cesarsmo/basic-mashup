...
link.rel = 'stylesheet';
link.href = 'grupoitg-nordica.us.qlikcloud.com/resources/autogenerated/qlik-styles.css';
...
script.onload = async () => {
	require.config({
		baseUrl: 'grupoitg-nordica.us.qlikcloud.com/resources',
		webIntegrationId: config.webIntegrationId
	  });

	// build a single-sign on URL and return back here once completed:
	const loginUrl = new URL('grupoitg-nordica.us.qlikcloud.com/login');
